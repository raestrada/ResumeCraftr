...
@click.option("--file", "-f", type=click.Path(exists=True), help="Path to a job description file.")
def add_job_description(job_name, content, file):
    ...
    if file:
        ...
        console.print("[bold red]You must provide either --content or --file.[/bold red]")
        return
    ...
    console.print(f"[bold green]Updated {CONFIG_FILE} with job description reference.[/bold green]")
